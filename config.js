...
//HEROKU  VARS
global.packname = process.env.PACKNAME ===undefined ? `ɴᴇᴇʀᴀᴊ-x0` : process.env.PACKNAME
global.author = process.env.AUTHOR  ===undefined ? `ᴍɪʟʟɪᴇ` : process.env.AUTHOR
global.session = process.env.SESSION_ID
global.thumburl = process.env.IMAGE ===undefined ? 'https://i.pinimg.com/474x/de/bd/b2/debdb24645169bf95eecd49f3144315f.jpg' :process.env.IMAGE
global.wm = process.env.WATERMARK === undefined ? `ᴍɪʟʟɪᴇ-ᴍᴅ` :process.env.WATERMARK
global.name = process.env.BOT_NAME ===undefined ? 'Millie Multi Device' : process.env.BOT_NAME
